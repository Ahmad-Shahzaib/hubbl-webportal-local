...
import { getCookie, removeCookie } from "dan-api/cookie";
import { IMGURL } from "dan-api/url";

const profileImage = JSON.parse(getCookie("user"));
let userprofile = avatarApi[6];

if (profileImage && profileImage.profile_image) {
  userprofile = profileImage.profile_image.includes("https:")
    ? profileImage.profile_image
    : IMGURL + profileImage.profile_image;
}
  ...
  return (
    <div>
      ...
      <Button onClick={handleMenu("user-setting")}>
        <Avatar alt={dummy.user.name} src={userprofile} />
      </Button>
      <Menu
        id="menu-appbar"
        anchorEl={anchorEl}
