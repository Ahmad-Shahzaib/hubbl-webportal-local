          ...
          <ul className={classes.bigResume}>
            <li>
              <Avatar
                ...
                style={{ backgroundColor: "#FF291C" }}
              >
                <Dvr />
              </Avatar>
              <Typography variant="h6">
                <span className={classes.blueText} style={{ color: "#FF291C" }}>
                  {data.timesheets}
                </span>
            ...
            <li>
              <Avatar
                ...
                style={{ backgroundColor: "#026DD1" }}
              >
                <CheckCircle />
              </Avatar>
              <Typography variant="h6">
                <span className={classes.tealText} style={{ color: "#026DD1" }}>
                  {data.expancesheets}
                </span>
            ...
            <li>
              <Avatar
                ...
                style={{ backgroundColor: "#EB7900" }}
              >
                <Healing />
              </Avatar>
              <Typography variant="h6">
                <span className={classes.pinkText} style={{ color: "#EB7900" }}>
                  {data.incomeForms}
                </span>
