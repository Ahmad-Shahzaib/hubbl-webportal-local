...
function Section2(props) {
  ...
  const _drivers_id = group_drivers ? group_drivers : "";

  const driver_values = drivers.find(
    (driver) => String(_drivers_id) == String(driver.id)
  );

  const main_driver = drivers.find(
    (driver) => String(driver_id) == String(driver.id)
  );
