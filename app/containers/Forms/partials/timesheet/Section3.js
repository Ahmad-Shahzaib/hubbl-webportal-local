...
function Section3(props) {
  ...
  useEffect(() => {
    let count = 0;
    let unit_count = day3_units ? day3_units.split(",") : [];
    let rate_count = day3_unit_rate ? day3_unit_rate.split(",") : [];
    let type_count = day3_unit_type ? day3_unit_type.split(",") : [];
    let total_count = day3_total ? day3_total.split(",") : [];
    let start_hours = day3_start_time_hours
      ? day3_start_time_hours.split(",")
      : [];
    let start_mins = day3_start_time_mins
      ? day3_start_time_mins.split(",")
      : [];
    let finish_hours = day3_finish_time_hours
      ? day3_finish_time_hours.split(",")
      : [];
    let finish_mins = day3_finish_time_mins
      ? day3_finish_time_mins.split(",")
      : [];
    let break_hours = day3_break_time_hours
      ? day3_break_time_hours.split(",")
      : [];
    let break_mins = day3_break_time_mins
      ? day3_break_time_mins.split(",")
      : [];
    let shift = day3_shift ? day3_shift.split(",") : [];
    let payable_amount = day3_payable_amount
      ? day3_payable_amount.split(",")
      : [];
    if (
  ...
  function removeForm(index) {
    ...
    handleChange(3, null, index, _forms, null, false);
    setForms(_forms);
  }
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("client", 2, _client, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("depot", 2, _depot, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        disabled={viewMode}
                        onChange={(e) =>
                          handleChange(3, "unit", index, forms, e.target.value)
                        }
                        required
                        style={styles().field}
                      />
                  ...
                  <div>
                    <FormControl variant="standard" style={styles().field}>
                      ...
                      <Select
                        ...
                        onChange={(e) =>
                          handleChange(3, "type", index, forms, e.target.value)
                        }
                      >
                        <MenuItem value="">
                          <em>None</em>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        inputMode="numeric"
                        onChange={(e) =>
                          handleChange(3, "rate", index, forms, e.target.value)
                        }
                        style={styles().field}
                      />
                    </div>
