...
function Section6(props) {
  ...
  useEffect(() => {
    let count = 0;
    let unit_count = day6_units ? day6_units.split(",") : [];
    let rate_count = day6_unit_rate ? day6_unit_rate.split(",") : [];
    let type_count = day6_unit_type ? day6_unit_type.split(",") : [];
    let total_count = day6_total ? day6_total.split(",") : [];
    let start_hours = day6_start_time_hours
      ? day6_start_time_hours.split(",")
      : [];
    let start_mins = day6_start_time_mins
      ? day6_start_time_mins.split(",")
      : [];
    let finish_hours = day6_finish_time_hours
      ? day6_finish_time_hours.split(",")
      : [];
    let finish_mins = day6_finish_time_mins
      ? day6_finish_time_mins.split(",")
      : [];
    let break_hours = day6_break_time_hours
      ? day6_break_time_hours.split(",")
      : [];
    let break_mins = day6_break_time_mins
      ? day6_break_time_mins.split(",")
      : [];
    let shift = day6_shift ? day6_shift.split(",") : [];
    let payable_amount = day6_payable_amount
      ? day6_payable_amount.split(",")
      : [];
    if (
  ...
  function removeForm(index) {
    ...
    handleChange(6, null, index, _forms, null, false);
    setForms(_forms);
  }
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("client", 5, _client, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("depot", 5, _depot, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        disabled={viewMode}
                        onChange={(e) =>
                          handleChange(6, "unit", index, forms, e.target.value)
                        }
                        required
                        style={styles().field}
                      />
                  ...
                  <div>
                    <FormControl variant="standard" style={styles().field}>
                      ...
                      <Select
                        ...
                        onChange={(e) =>
                          handleChange(6, "type", index, forms, e.target.value)
                        }
                      >
                        <MenuItem value="">
                          <em>None</em>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        inputMode="numeric"
                        onChange={(e) =>
                          handleChange(6, "rate", index, forms, e.target.value)
                        }
                        style={styles().field}
                      />
                    </div>
