...
function Section1(props) {
  ...
  useEffect(() => {
    let count = 0;
    let unit_count = day1_units ? day1_units.split(",") : [];
    let rate_count = day1_unit_rate ? day1_unit_rate.split(",") : [];
    let type_count = day1_unit_type ? day1_unit_type.split(",") : [];
    let total_count = day1_total ? day1_total.split(",") : [];
    let start_hours = day1_start_time_hours
      ? day1_start_time_hours.split(",")
      : [];
    let start_mins = day1_start_time_mins
      ? day1_start_time_mins.split(",")
      : [];
    let finish_hours = day1_finish_time_hours
      ? day1_finish_time_hours.split(",")
      : [];
    let finish_mins = day1_finish_time_mins
      ? day1_finish_time_mins.split(",")
      : [];
    let break_hours = day1_break_time_hours
      ? day1_break_time_hours.split(",")
      : [];
    let break_mins = day1_break_time_mins
      ? day1_break_time_mins.split(",")
      : [];
    let shift = day1_shift ? day1_shift.split(",") : [];
    let payable_amount = day1_payable_amount
      ? day1_payable_amount.split(",")
      : [];
    if (
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("client", 0, _client, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("depot", 0, _depot, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        disabled={viewMode}
                        onChange={(e) =>
                          handleChange(1, "unit", index, forms, e.target.value)
                        }
                        required
                        style={styles().field}
                      />
                  ...
                  <div>
                    <FormControl variant="standard" style={styles().field}>
                      ...
                      <Select
                        ...
                        onChange={(e) =>
                          handleChange(1, "type", index, forms, e.target.value)
                        }
                      >
                        <MenuItem value="">
                          <em>None</em>
