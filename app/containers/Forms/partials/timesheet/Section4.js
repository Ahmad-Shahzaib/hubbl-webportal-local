...
function Section4(props) {
  ...
  useEffect(() => {
    let count = 0;
    let unit_count = day4_units ? day4_units.split(",") : [];
    let rate_count = day4_unit_rate ? day4_unit_rate.split(",") : [];
    let type_count = day4_unit_type ? day4_unit_type.split(",") : [];
    let total_count = day4_total ? day4_total.split(",") : [];
    let start_hours = day4_start_time_hours
      ? day4_start_time_hours.split(",")
      : [];
    let start_mins = day4_start_time_mins
      ? day4_start_time_mins.split(",")
      : [];
    let finish_hours = day4_finish_time_hours
      ? day4_finish_time_hours.split(",")
      : [];
    let finish_mins = day4_finish_time_mins
      ? day4_finish_time_mins.split(",")
      : [];
    let break_hours = day4_break_time_hours
      ? day4_break_time_hours.split(",")
      : [];
    let break_mins = day4_break_time_mins
      ? day4_break_time_mins.split(",")
      : [];
    let shift = day4_shift ? day4_shift.split(",") : [];
    let payable_amount = day4_payable_amount
      ? day4_payable_amount.split(",")
      : [];
    if (
  ...
  function removeForm(index) {
    ...
    handleChange(4, null, index, _forms, null, false);
    setForms(_forms);
  }
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("client", 3, _client, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("depot", 3, _depot, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        disabled={viewMode}
                        onChange={(e) =>
                          handleChange(4, "unit", index, forms, e.target.value)
                        }
                        required
                        style={styles().field}
                      />
                  ...
                  <div>
                    <FormControl variant="standard" style={styles().field}>
                      ...
                      <Select
                        ...
                        onChange={(e) =>
                          handleChange(4, "type", index, forms, e.target.value)
                        }
                      >
                        <MenuItem value="">
                          <em>None</em>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        inputMode="numeric"
                        onChange={(e) =>
                          handleChange(4, "rate", index, forms, e.target.value)
                        }
                        style={styles().field}
                      />
                    </div>
