...
function Section5(props) {
  ...
  useEffect(() => {
    let count = 0;
    let unit_count = day5_units ? day5_units.split(",") : [];
    let rate_count = day5_unit_rate ? day5_unit_rate.split(",") : [];
    let type_count = day5_unit_type ? day5_unit_type.split(",") : [];
    let total_count = day5_total ? day5_total.split(",") : [];
    let start_hours = day5_start_time_hours
      ? day5_start_time_hours.split(",")
      : [];
    let start_mins = day5_start_time_mins
      ? day5_start_time_mins.split(",")
      : [];
    let finish_hours = day5_finish_time_hours
      ? day5_finish_time_hours.split(",")
      : [];
    let finish_mins = day5_finish_time_mins
      ? day5_finish_time_mins.split(",")
      : [];
    let break_hours = day5_break_time_hours
      ? day5_break_time_hours.split(",")
      : [];
    let break_mins = day5_break_time_mins
      ? day5_break_time_mins.split(",")
      : [];
    let shift = day5_shift ? day5_shift.split(",") : [];
    let payable_amount = day5_payable_amount
      ? day5_payable_amount.split(",")
      : [];
    if (
  ...
  function removeForm(index) {
    ...
    handleChange(5, null, index, _forms, null, false);
    setForms(_forms);
  }
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("client", 4, _client, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("depot", 4, _depot, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        disabled={viewMode}
                        onChange={(e) =>
                          handleChange(5, "unit", index, forms, e.target.value)
                        }
                        required
                        style={styles().field}
                      />
                  ...
                  <div>
                    <FormControl variant="standard" style={styles().field}>
                      ...
                      <Select
                        ...
                        onChange={(e) =>
                          handleChange(5, "type", index, forms, e.target.value)
                        }
                      >
                        <MenuItem value="">
                          <em>None</em>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        inputMode="numeric"
                        onChange={(e) =>
                          handleChange(5, "rate", index, forms, e.target.value)
                        }
                        style={styles().field}
                      />
                    </div>
