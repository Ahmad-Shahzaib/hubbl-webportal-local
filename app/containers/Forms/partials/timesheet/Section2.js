...
function Section2(props) {
  ...
  useEffect(() => {
    let count = 0;
    let unit_count = day2_units ? day2_units.split(",") : [];
    let rate_count = day2_unit_rate ? day2_unit_rate.split(",") : [];
    let type_count = day2_unit_type ? day2_unit_type.split(",") : [];
    let total_count = day2_total ? day2_total.split(",") : [];
    let start_hours = day2_start_time_hours
      ? day2_start_time_hours.split(",")
      : [];
    let start_mins = day2_start_time_mins
      ? day2_start_time_mins.split(",")
      : [];
    let finish_hours = day2_finish_time_hours
      ? day2_finish_time_hours.split(",")
      : [];
    let finish_mins = day2_finish_time_mins
      ? day2_finish_time_mins.split(",")
      : [];
    let break_hours = day2_break_time_hours
      ? day2_break_time_hours.split(",")
      : [];
    let break_mins = day2_break_time_mins
      ? day2_break_time_mins.split(",")
      : [];
    let shift = day2_shift ? day2_shift.split(",") : [];
    let payable_amount = day2_payable_amount
      ? day2_payable_amount.split(",")
      : [];
    if (
  ...
  function removeForm(index) {
    ...
    handleChange(2, null, index, _forms, null, false);
    setForms(_forms);
  }
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("client", 1, _client, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
              ...
              <Grid md={6} sm={12} xs={12} item>
                <div>
                  <TextField
                    ...
                    disabled={viewMode}
                    onChange={(e) =>
                      handleChangeCD("depot", 1, _depot, e.target.value)
                    }
                    style={styles().field}
                  />
                </div>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        disabled={viewMode}
                        onChange={(e) =>
                          handleChange(2, "unit", index, forms, e.target.value)
                        }
                        required
                        style={styles().field}
                      />
                  ...
                  <div>
                    <FormControl variant="standard" style={styles().field}>
                      ...
                      <Select
                        ...
                        onChange={(e) =>
                          handleChange(2, "type", index, forms, e.target.value)
                        }
                      >
                        <MenuItem value="">
                          <em>None</em>
                  ...
                  <Grid md={2} sm={12} xs={12} item>
                    <div>
                      <TextField
                        ...
                        inputMode="numeric"
                        onChange={(e) =>
                          handleChange(2, "rate", index, forms, e.target.value)
                        }
                        style={styles().field}
                      />
                    </div>
