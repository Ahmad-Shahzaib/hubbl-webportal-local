...
function Section1(props) {
  ...
  useEffect(() => {
    let count = 0;
    let unit_count = insurance_units ? insurance_units.split(",") : [];
    let type_count = insurance_text ? insurance_text.split(",") : [];
    let total_count = insurance_price ? insurance_price.split(",") : [];
    ...
    setForms(_forms);
  }, [insurance_units, insurance_text]);
