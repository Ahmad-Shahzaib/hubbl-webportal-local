...
function Section1(props) {
  ...
  useEffect(() => {
    let count = 0;
    let unit_count = expenditure_units ? expenditure_units.split(",") : [];
    let type_count = expenditure_text ? expenditure_text.split(",") : [];
    let total_count = expenditure_price ? expenditure_price.split(",") : [];
    ...
    setForms(_forms);
  }, [expenditure_units, expenditure_text]);
