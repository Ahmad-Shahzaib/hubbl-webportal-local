...
function Section1(props) {
  ...
  useEffect(() => {
    let count = 0;
    let unit_count = miscellaneous_prices
      ? miscellaneous_prices.split(",")
      : [];
    let type_count = miscellaneous_desc ? miscellaneous_desc.split(",") : [];
    let total_count = miscellaneous_total ? miscellaneous_total.split(",") : [];
    ...
    setForms(_forms);
  }, [miscellaneous_prices, miscellaneous_desc]);
