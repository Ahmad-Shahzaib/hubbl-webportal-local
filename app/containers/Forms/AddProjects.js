        ...
        .then((res) => {
          ...
          if (res.data.status == 200) {
            ...
            if (stayHere === false) {
              ...
              setTimeout(() => {
                history.push("nft-official-projects");
              }, 1500);
            }
          } else {
            setData(defaultDataConfig);
  ...
  return (
    <div>
      ...
      <PapperBlock
        ...
        desc="Fillout the required information below to create a new Project"
      >
        <div>
          <Grid
            container
