...
function EditSubstitution(props) {
    ...
    axios({
      ...
      .then((res) => {
        if (res.data.status == 200) {
          setData(nullToEmptyValues(res.data.job));
  ...
  return (
    <div>
      ...
      <PapperBlock
        title="Edit Substitution Job"
        icon="ion-ios-list-box-outline"
        desc="Fillout the required information below to update substitution job details"
      >
        <div>
          <Grid
            container
...
export default EditSubstitution;
