...
function HgvAccountancyPaid(props) {
  ...
  function onEdit() {
    if (dataIDs.length == 1) {
      ...
      setCookie("redirect", "hgv-accountancy-paid");
  ...
  return (
    <div>
      ...
      <PapperBlock
        whiteBg
        icon="ion-ios-paper"
        title="HGV Driver Hub - HGV Accountancy Paid"
        desc="HGV Accountancy Paid List"
      >
        <Grid
          xs={12}
          md={12}
...
export default withStyles(styles)(HgvAccountancyPaid);
