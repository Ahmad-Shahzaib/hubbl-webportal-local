...
function DriverOwnSelfPaid(props) {
  ...
  function onEdit() {
    if (dataIDs.length == 1) {
      ...
      setCookie("redirect", "driver-own-self-paid");
      // window.location.href = "/app/Edit-Timesheet";
      history.push("driver-own-self-paid");
    } else {
      setDialog({
        open: true,
        title: "Exception!",
  ...
  return (
    <div>
      ...
      <PapperBlock
        whiteBg
        icon="ion-ios-paper"
        title="HGV Driver Hub - Driver Own Self Paid"
        desc="Driver Own Self Paid List"
      >
        <Grid
          xs={12}
          md={12}
...
export default withStyles(styles)(DriverOwnSelfPaid);
