...
function EnhancedDriver(props) {
  ...
  function onEdit() {
    if (dataIDs.length == 1) {
      ...
      setCookie("redirect", "enhanced-driver");
  ...
  return (
    <div>
      ...
      <PapperBlock
        whiteBg
        icon="ion-ios-paper"
        title="HGV Driver Hub - Enhanced Driver"
        desc="Enhanced Driver Timesheet List"
      >
        <Grid
          xs={12}
          md={12}
...
export default withStyles(styles)(EnhancedDriver);
