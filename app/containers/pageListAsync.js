...
export const AllUsers = loadable(() => import("./Tables/main/AllUsers"), {
  fallback: <Loading />,
});

export const AllAnalytics = loadable(
  () => import("./Tables/main/AllAnalytics"),
  {
    fallback: <Loading />,
  }
);
export const EditUser = loadable(() => import("./Forms/EditUser"), {
  fallback: <Loading />,
});
...
export const AllFeedbacks = loadable(
  () => import("./Tables/main/AllFeedbacks"),
  {
    fallback: <Loading />,
  }
);
...
export const AddAdmin = loadable(() => import("./Forms/AddAdmin"), {
  fallback: <Loading />,
});

export const EditAdmin = loadable(() => import("./Forms/EditAdmin"), {
  fallback: <Loading />,
});

export const AddStaff = loadable(() => import("./Forms/AddStaff"), {
  fallback: <Loading />,
});

export const EditStaff = loadable(() => import("./Forms/EditStaff"), {
  fallback: <Loading />,
});

export const AddIR35CategoryForm = loadable(
  () => import("./Forms/AddIR35CategoryForm"),
  {
    fallback: <Loading />,
  }
);

export const EditIR35CategoryForm = loadable(
  () => import("./Forms/EditIR35CategoryForm"),
  {
    fallback: <Loading />,
  }
);

export const AddIR35ItemForm = loadable(
  () => import("./Forms/AddIR35ItemForm"),
  {
    fallback: <Loading />,
  }
);

export const EditIR35ItemForm = loadable(
  () => import("./Forms/EditIR35ItemForm"),
  {
    fallback: <Loading />,
  }
);

export const AddDriver = loadable(() => import("./Forms/AddDriver"), {
  fallback: <Loading />,
});

export const EditDriver = loadable(() => import("./Forms/EditDriver"), {
  fallback: <Loading />,
});

export const AddHirers = loadable(() => import("./Forms/AddHirers"), {
  fallback: <Loading />,
});

export const EditHirer = loadable(() => import("./Forms/EditHirer"), {
  fallback: <Loading />,
});

export const AddAgencyJobs = loadable(() => import("./Forms/AddAgencyJobs"), {
  fallback: <Loading />,
});
export const EditAgencyJobs = loadable(() => import("./Forms/EditAgencyJobs"), {
  fallback: <Loading />,
});
export const AddSubstitutions = loadable(
  () => import("./Forms/AddSubstitutions"),
  {
    fallback: <Loading />,
  }
);
export const EditSubstitutions = loadable(
  () => import("./Forms/EditSubstitution"),
  {
    fallback: <Loading />,
  }
);

export const AddJob = loadable(() => import("./Forms/AddJob"), {
  fallback: <Loading />,
});
export const EditJob = loadable(() => import("./Forms/EditJob"), {
  fallback: <Loading />,
});

export const EditTimesheet = loadable(() => import("./Forms/EditTimesheet"), {
  fallback: <Loading />,
});
export const EditExpensesheet = loadable(
  () => import("./Forms/EditExpensesheet"),
  {
    fallback: <Loading />,
  }
);

export const AddExpenseAllowances = loadable(
  () => import("./Forms/AddExpenseAllowances"),
  {
    fallback: <Loading />,
  }
);

export const HgvDetails = loadable(() => import("./Forms/HgvDetails"), {
  fallback: <Loading />,
});
export const EditAllowances = loadable(() => import("./Forms/EditAllowances"), {
  fallback: <Loading />,
});
export const EmailFacility = loadable(() => import("./Forms/EmailFacility"), {
  fallback: <Loading />,
});
...
export const OTP = loadable(() => import("./Pages/Users/OTP"), {
  fallback: <Loading />,
});
